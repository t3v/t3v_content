...
plugin {
  tx_t3vcontent {
    ...
    view {
      ...
      # Used to define several paths for partials, which will be tried in reversed order.
      # The first folder where the desired partial is found, is used. The keys of the array define the order.
      partialRootPaths {
