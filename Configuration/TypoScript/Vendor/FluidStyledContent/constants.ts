...
lib {
  contentElement {
    layoutRootPath = EXT:t3v_content/Resources/Private/Layouts/Vendor/FluidStyledContent/8.7/

    templateRootPath = EXT:t3v_content/Resources/Private/Templates/Vendor/FluidStyledContent/8.7/

    partialRootPath = EXT:t3v_content/Resources/Private/Partials/Vendor/FluidStyledContent/8.7/
  }
}
[global]
