 ...
 */
class ContentObjectUtility {
  /**
   * Gets a content object identifier from an content object key.
   *
  ...
  public static function contentObjectIdentifier(string $contentObjectKey): string {
    ...
    if (strpos($contentObjectIdentifier, '_') ||
      ...
      $contentObjectIdentifier = str_replace(['_', '-'], ' ', $contentObjectIdentifier);
  ...
  /**
   * Alias for the `contentObjectIdentifier` function.
   *
   * @param string $contentObjectKey The content object key
   * @return string The content object identifier
   */
  public static function getContentElementIdentifier(string $contentObjectKey): string {
    return self::contentObjectIdentifier($contentObjectKey);
  }
  ...
  /**
   * Alias for the `contentObjectSignature` function.
   *
   * @param string $extensionIdentifier The extension identifier
   * @param string $contentObjectIdentifier The content object identifier
   * @return string The content object signature
   */
  public static function getContentElementSignature(string $extensionIdentifier, string $contentObjectIdentifier): string {
    return self::contentObjectSignature($extensionIdentifier, $contentObjectIdentifier);
  }
}
