<?php
namespace T3v\T3vContent\Tests\Functional;
 ...
 *
 * @package T3v\T3vContent\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase {
  ...
  protected function setUp() {
    ...
    $this->setUpFrontendRootPage(1, ['EXT:t3v_content/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
  }
