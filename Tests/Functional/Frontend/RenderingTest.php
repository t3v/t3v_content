...
namespace T3v\T3vContent\Tests\Functional\Frontend;
 ...
 *
 * @package T3v\T3vContent\Tests\Functional\Frontend
 */
class RenderingTest extends FunctionalTestCase
{
    ...
    public function templateIsRendered(): void
    {
        ...
        if ($response->getStatusCode() === 200) {
            ...
            self::assertStringContainsString('Home | T3v Content', $titleTag->nodeValue);
    ...
    protected function setUp(): void
    {
        ...
        $this->setUpFrontend(1, 'T3v Content');
    }
}
